<%-- 
    Document   : Wrongidpaswd
    Created on : 31-Aug-2014, 8:49:55 AM
    Author     : Abdulquader
--%>

<%@page import="pack1.TpaRegisterServ"%>
...
<div id="wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title="">TPA Register Success</a></li>
...
for Shared Data in the Cloud
                    ...
                    <center><h1><strong><%=TpaRegisterServ.fullname%>  has been made Third Party Auditor !!! </strong></h1>
                    <span class="byline">Please click on button below to go back to Home page</span>
                    </center>
		<ul class="actions">
			<li><a href="index.jsp" class="button">Back to Home page</a></li>
		</ul>
                </div>
