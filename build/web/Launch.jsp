...
<div id="wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title="">Launch</a></li>
	...
	<div id="featured">
		<div class="container">
			<div class="title">
				<h2>ORUTA</h2><br><br><br>
				<span class="byline">Privacy-Preserving Public Auditing
for Shared Data in the Cloud
</span></div>
                    <center><p><strong>To launch your cloud window please click on button below</strong></p></center>
		<form id="form1" method="post" action="LaunchServ">
                <input id="inputsubmit1" type="submit" class="button" name="inputsubmit1" value="Launch" />
                </form>
                </div>
