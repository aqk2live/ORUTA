<%-- 
    Document   : index
    Created on : 30-Mar-2014, 9:47:20 PM
    Author     : Abdulquader
--%>
...
<div id="wrapper">
	<div id="header" class="container">
		<div id="logo">
			<h1><a href="#">ORUTA Cloud
</a></h1>
		</div>
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title="">Homepage</a></li>
                                                                                   <li><a href="Auditor.jsp" accesskey="2" title="">Auditor Login</a></li>
				<li><a href="Our_Clients.jsp" accesskey="2" title="">Our Clients</a></li>
...
for Shared Data in the Cloud
		...
		<ul class="actions">
			<li><a href="Login.jsp" class="button">User Access</a></li>
                        <li><a href="AdminLogin.jsp" class="button">Admin Access</a></li>
		</ul>
	</div>
	<div id="extra" class="container">
		...
		<ul class="actions">
			<li><a href="#" class="button">More on Cloud</a></li>
		</ul>
	</div>
