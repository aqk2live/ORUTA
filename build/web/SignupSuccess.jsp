...
<div id="wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title="">SignUp Success</a></li>
...
for Shared Data in the Cloud
                    ...
                    <center><h1><strong>Sign up Success !!!</strong></h1>
                        <span class="byline"><a href="Login.jsp">Login Now !!!</a></span>
                    </center>
