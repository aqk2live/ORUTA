...
<div id="wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title=""> Password change success</a></li>
...
for Shared Data in the Cloud
                    ...
                    <center><h1><strong>Password change successful !!! </strong></h1>
                    <span class="byline">Please click on button below to go back to Login page</span>
                    </center>
		<ul class="actions">
			<li><a href="Login.jsp" class="button">Login Page</a></li>
		</ul>
                </div>
