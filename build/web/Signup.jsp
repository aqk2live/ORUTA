<%-- 
    Document   : Signup
    Created on : 31-Mar-2014, 7:27:59 AM
    Author     : Abdulquader
--%>
		...
		<div class="container">
			<div class="title">
				<h2>Please enter Details</h2>
                                ...
                                <form id="form1" method="post" action="SignupServ">
                                    <center>
				...
				<tr>
                                ...
                                <tr>
                                    <td><label for="inputtext1">First name :</label></td>
                                <td><input id="inputtext1" type="text" name="firstname" value="" /></td>
                                </tr><tr></tr>
                                                <tr>
                                <td><label for="inputtext2">Last name :</label></td>
                                ...
                                <td><textarea rows="4" cols="16" name="address">
                                    ...
                                    <input id="inputsubmit1" type="submit" name="inputsubmit1" value="            Create Account            " /><br></br>
