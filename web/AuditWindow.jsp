...
<div id="wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title="">Auditor Page</a></li>
				<li><a href="IllegalUsers.jsp" accesskey="5" title="">Illegal Users</a></li>
	...
	<div id="featured">
		<div class="container">
			<div class="title">
                            <h2 style=" color:  #ffffff">Welcome Auditor</h2><br><br><br>
  ...
  <img src="images/Turning_pages.gif" title="Click here to see user Files" style=" color:  #79C255; width: 30px; height: 30px; border: 0">
            </a></td>
                                            <td style='text-align:center;vertical-align:middle'><a href="sharefiles.jsp?unm=<%=usernm%>">
  <img src="images/sharefile.png" title="Click here to see shared Files" style=" color:  #79C255; width: 30px; height: 30px; border: 0">
            </a></td>
                                        </tr>
                               <% }%>
                                        </table> 
