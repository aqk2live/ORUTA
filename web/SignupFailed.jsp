<%-- 
    Document   : SignupFailed
    Created on : 22-Nov-2014, 6:25:32 PM
    Author     : Abdulquader
--%>
...
<div id="wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title="">SignUp Failed</a></li>
...
for Shared Data in the Cloud
                    ...
                    <center><h1><strong>Sign up Failed !!!</strong></h1>
                    <span class="byline">As username you have entered already exists Please try with different username </span>
                    </center>
		<ul class="actions">
                    <li><button type="button" class="button" name="back" onclick="history.back()">BACK</button></li>
		</ul>
                </div>
