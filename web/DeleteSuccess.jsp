<%-- 
    ...
    Created on : 31-Mar-2014, 8:49:55 AM
    Author     : Abdulquader
--%>
...
<div id="wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title="">User Deleted Success</a></li>
...
for Shared Data in the Cloud
                    ...
                    <center><h1><strong>User Deleted Successfully !!! </strong></h1>
