<%-- 
    Document   : Login
    Created on : 30-Mar-2014, 10:38:02 PM
    Author     : Abdulquader
--%>
...
for Shared Data in the Cloud
                                ...
                                <form id="form1" method="post" action="LoginServ">
                                    <center><table>
                                        <tr>
                                            <td><label for="inputtext1">Client ID :</label></td>
                                ...
                                <br></br>
                                    ...
                                    <input id="inputsubmit1" type="submit" name="inputsubmit1" value="            Please Enter            " /><br></br>
